...
<div class="max-w-2xl">
    <div class="bg-white rounded-lg shadow p-6">
        <form action="/admin/menu-items/{{ $menuItem->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                @if($menuItem->image_path)
                    <div class="mt-3">
                        ...
                        <img src="{{ Storage::url($menuItem->image_path) }}" alt="{{ $menuItem->name }}" class="h-24 w-24 rounded object-cover">
                    </div>
                @endif
            </div>
